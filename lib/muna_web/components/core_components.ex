defmodule MunaWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="hidden relative rounded-sm bg-white p-14 shadow-zinc-700/10 ring-1 ring-zinc-700/10 transition"
            >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MunaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MunaWeb.Gettext, "errors", msg, opts)
    end
  end
